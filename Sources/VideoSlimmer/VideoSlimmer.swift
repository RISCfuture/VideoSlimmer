...
struct VideoSlimmer: AsyncParsableCommand {
  static let configuration = CommandConfiguration(
    abstract:
      "A tool that removes unneeded audio and subtitle tracks from a movie container file using FFMPEG.",
    usage: """
  ...
  @Argument(
    help: "The output path for the slimmed video file",
    completion: .file(),
    transform: { URL(filePath: $0, directoryHint: .notDirectory) }
  )
  var output: URL
